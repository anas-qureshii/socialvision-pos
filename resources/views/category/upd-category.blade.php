...
@section('content')
    <div class="w-full bg-white shadow shadow-gray-200 flex flex-col rounded p-2">
        <div class="flex w-full">
            <h6 class="p-2"><a href="/" class="text-[#1447e6] themeFont text-lg">Home</a> / <a href="/" class="text-[#1447e6] themeFont text-lg">category</a> / <span
                    class="themeFont text-gray-400 text-lg">Title here</span></h6>
        </div>
        <h2 class="themeFont text-3xl capitalize mt-4 font-semibold px-2 ">Update Category</h2>
